...
const SocialMedia = () => {
  const socialLinks = [
    { name: 'Facebook', href: 'https://web.facebook.com/bigpay77aud', icon: '/SocialMediaIcons/bp77-fb.png' },
    { name: 'Telegram', href: 'https://t.me/bigpay77au', icon: '/SocialMediaIcons/bp77-tlg.png' },
    { name: 'Twitter', href: 'https://x.com/bigpay77', icon: '/SocialMediaIcons/bp77-tw.png' },
    { name: 'Movie', href: 'https://www.facebook.com/people/Bigpay77-Movie/100095301500281/', icon: '/SocialMediaIcons/bp77-mv.png' }
  ];
    ...
    <section className="py-4 sm:py-10 lg:py-16 px-4 pb-16">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-[#ecf3ff] text-sm sm:text-base lg:text-lg px-2 font-['Orbitron'] font-light mt-6">
          Stay connected with Bigpay77 Australia's most trusted casino review community
        </p>
      </div>
